...
#CPK ^^ Nice work computing sem with mean, lots of folks missed that.
...
#CPK: No need to specify by if col names are shared. Also, we wanted to join by more this fish, but speed too as the prompt indicated [-1].
# 6
...
#CPK: Pretty good stuff. Getting solid.
